...
int array[4];  
  ...
  #ifdef BUILD_LK    
  printf("************luke: ili9881 %s %d, id = 0x%08x\n", __func__,__LINE__, id_high);
  #else    
	  printk("*********luke: ili9881 %s %d, id = 0x%08x\n", __func__,__LINE__, id_high);
  #endif	
  return (id_high == LCM_ID_ILI9881) ?1:0;
}
