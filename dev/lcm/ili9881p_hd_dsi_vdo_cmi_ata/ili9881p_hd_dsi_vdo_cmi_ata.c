...
//PWU6_BPZN_P1 haifei ili9881p panda 1440*720
	...
	{0x04,1,{0x70}},     //70?¨ºo4lane, 71?¨ºo3lane,
...
#ifdef BUILD_LK
	dprintf(CRITICAL, "%s, LK debug: ili9881p id = 0x%08x\n", __func__, id);
#else
	printk("%s: ili9881p id = 0x%08x \n", __func__, id);
#endif

	return (0x008000 == id)?1:0;
}

LCM_DRIVER ili9881p_hd_dsi_vdo_cmi_ata_lcm_drv = {
	.name		= "ili9881p_hd_dsi_vdo_cmi_ata",
