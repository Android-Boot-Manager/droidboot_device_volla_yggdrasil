...
//prize-modify-pengzhipeng-20190319-start
extern int IMM_GetOneChannelValue(int dwChannel, int data[4], int* rawdata);
#define AUX_IN2_LCD_ID	2
#define MIN_VOLTAGE 850
...
static unsigned int lcm_compare_id(void)
{
	...
	ret = IMM_GetOneChannelValue(AUX_IN2_LCD_ID, data, &rawdata);	
...
#ifdef BUILD_LK
    printf("cjx: ft8006 %s, lcm_vol =%d id = 0x%x, buffer[0] = %x, buffer[1] = %x\n", __func__, lcm_vol,id, buffer[0], buffer[1]);
#else
    printf("cjx: ft8006 %s, lcm_vol =%d id = 0x%x, buffer[0] = %x, buffer[1] = %x\n", __func__, lcm_vol,id, buffer[0], buffer[1]);
...
//prize-modify-pengzhipeng-20190319-end
...
LCM_DRIVER ft8006p_hdp_dsi_vdo_tm6217_drip_incell_lcm_drv =
{
