...
//prize lsw add for vibr 20190817 start
void vibr_Enable_HW(void)
{
	pmic_set_register_value(PMIC_RG_VIBR_VOSEL, 9);//VIBR_voltage 1-9 ---->1.1V-3.3V  default 2.8V
...
//prize lsw add for vibr 20190817 end
