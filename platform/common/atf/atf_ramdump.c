...
#pragma weak atf_log_init
	...
	/* skip MMU_MEMORY_TYPE_NORMAL_WRITE_BACK | MMU_MEMORY_AP_P_RW_U_NA */
	/* only define when MTK_3LEVEL_PAGETABLE is defined */
...
/* if no support MTK_3LEVEL_PAGETABLE, no define following macros */
/* MMU_MEMORY_TYPE_NORMAL_WRITE_BACK | MMU_MEMORY_AP_P_RW_U_NA */
/* declare an empty atf_log_init() */
void atf_log_init(void)
{
}
#endif
