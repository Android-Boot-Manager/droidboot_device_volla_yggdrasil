...
#ifndef PRIZE_HDINFO_LEN
#define PRIZE_HDINFO_LEN 32
#endif
/* end */
...
/* begin, prize-lifenfen-20181120, add for hardware info, ddr, etc. */
	u32 emmc_lpddr_used_index;
	u32 flash_type;
	u8  prize_ddr_hardinfo[PRIZE_HDINFO_LEN];
/* end */
} BOOT_ARGUMENT;
...
/* begin, prize-lifenfen-20181120, add for hardware info, ddr, etc. */
#if 1
#define BOOT_TAG_LPDDR_EMCP_INFO      0x88620001
struct boot_tag_lpddr_emcp_info {
	u32 pl_lpddr_emcp_use_index;
	u32 pl_lpddr_emcp_type;
	u8  pl_lpddr_emcp_hardinfo[PRIZE_HDINFO_LEN];
};
#endif
/* end */
...
/* begin, prize-lifenfen-20181120, add for hardware info, ddr, etc. */
#if 1
		struct boot_tag_lpddr_emcp_info lpddr_emcp_info;
#endif
/* end */
	} u;
};
