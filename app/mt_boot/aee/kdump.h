...
int kdump_null_output(const struct mrdump_control_block *kparams, const struct kzip_addlist *memlist);
...
int kdump_usb_output(const struct mrdump_control_block *mrdump_cb, const struct kzip_addlist *memlist);

void kdump_core_header_init(const struct mrdump_control_block *kparams, const struct kzip_addlist *memlist);
void kdump_core32_header_init(const struct mrdump_control_block *kparams, const struct kzip_addlist *memlist);
void kdump_core64_header_init(const struct mrdump_control_block *kparams, const struct kzip_addlist *memlist);
